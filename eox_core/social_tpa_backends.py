...
class ConfigurableConnectOAuth2(BaseOAuth2):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(ConfigurableConnectOAuth2, self).__init__(*args, **kwargs)

    def get_user_details(self, response):
        """Get user details."""
        details = response.get([self.RESPONSE_ATTRIBUTES_KEY], {})
        fullname, first_name, last_name = self.get_user_names(self._get_user_name_values(detail))
        return {
